...
exports.openApiSpec = {
    ...
    info: {
        title: "Drenoday API",
        version: "1.0.0",
        description: "API do Drenoday — plataforma de hospedagem e deploy de aplicações.\n\n" +
            "Base URL: `/api/v1`\n\n" +
            "## Autenticação\n\n" +
    ...
    paths: {
        ...
        "/api/v1/auth/login": {
            post: {
                ...
                description: "Autentica o utilizador com username e password. Retorna um token JWT " +
        ...
        "/api/v1/auth/email": {
            post: {
                ...
                description: "Autentica o utilizador usando email e código de verificação.\n\n" +
        ...
        "/api/v1/auth/send-code-verification": {
            post: {
                ...
                description: "Envia um código de verificação de 6 dígitos para o email do " +
        ...
        "/api/v1/auth/verify-code": {
            post: {
                ...
                description: "Verifica o código de 6 dígitos enviado para o email do utilizador.",
        ...
        "/api/v1/auth/forgot-password": {
            post: {
                ...
                description: "Envia um token de recuperação de palavra-passe para o email do " +
        ...
        "/api/v1/auth/reset-password": {
            post: {
                ...
                description: "Redefine a palavra-passe usando o token recebido por email.",
        ...
        "/api/v1/auth/github": {
            get: {
                ...
                description: "Redireciona o utilizador para o fluxo de autenticação OAuth do GitHub. " +
        ...
        "/api/v1/auth/google": {
            get: {
                ...
                description: "Redireciona o utilizador para o fluxo de autenticação OAuth do Google. " +
        ...
        "/api/v1/user/create": {
            post: {
                ...
                description: "Regista um novo utilizador na plataforma. O username é gerado " +
        ...
        "/api/v1/user/me": {
            get: {
                ...
                description: "Retorna os dados do perfil do utilizador atualmente autenticado.",
                operationId: "getMe",
                security: [{ bearerAuth: [] }],
                responses: {
                    "200": {
        ...
        "/api/v1/user/all": {
            get: {
                ...
                description: "Retorna uma lista paginada de todos os utilizadores registados.",
        ...
        "/api/v1/github/list/repo": {
            get: {
                ...
                description: "Retorna a lista de repositórios do GitHub do utilizador autenticado.",
        ...
        "/api/v1/github/sync": {
            put: {
                ...
                description: "Associa a conta do GitHub ao perfil do utilizador na plataforma.",
        ...
        "/api/v1/project/create": {
            post: {
                ...
                description: "Cria um novo projeto de hospedagem. O subdomínio é gerado automaticamente " +
        ...
        "/api/v1/project/each/{projectId}": {
            get: {
                ...
                description: "Retorna os detalhes de um projeto específico, incluindo informações " +
        ...
        "/api/v1/project/{projectId}/deploy-token": {
            get: {
                ...
                description: "Retorna o token de deploy do projeto. Este token é usado para " +
        ...
        "/api/v1/project/{projectId}/regenerate-token": {
            post: {
                ...
                description: "Gera um novo token de deploy para o projeto. O token anterior " +
                    "deixa de ser válido.",
        ...
        "/api/v1/project/my": {
            get: {
                ...
                description: "Retorna a lista paginada de projetos do utilizador autenticado, " +
        ...
        "/api/v1/project/update/{projectId}": {
            put: {
                ...
                description: "Atualiza as configurações de um projeto. Apenas o utilizador com " +
        ...
        "/api/v1/project/delete/{projectId}": {
            delete: {
                ...
                description: "Elimina um projeto e todos os seus dados associados (deploys, " +
        ...
        "/api/v1/workspace/member/add": {
            post: {
                ...
                description: "Adiciona um utilizador ao workspace do projeto com um papel específico.",
        ...
        "/api/v1/deploy": {
            post: {
                ...
                description: "Faz o deploy de uma aplicação Docker. Requer o **deploy_token** " +
                        ...
                        "application/json": {
                            schema: {
                                ...
                                properties: {
                                    app: {
                                        type: "string",
                                        description: "Nome da aplicação (subdomínio do projeto)",
                                        example: "meu-app",
                                    },
                                    image: {
                                        type: "string",
        ...
        "/api/v1/deploy/{deployId}/cancel": {
            post: {
                ...
                description: "Cancela um deploy em execução. Para o container Docker associado " +
        ...
        "/api/v1/plan/create": {
            post: {
                ...
                description: "Cria um novo plano de assinatura com preço, duração e limite de projetos.",
        ...
        "/api/v1/pay/create": {
            post: {
                ...
                description: "Regista um novo pagamento com comprovativo para um projeto.",
        ...
        "/api/v1/pay/confirm": {
            post: {
                ...
                description: "Confirma ou rejeita um pagamento pendente. Envia notificação via socket.",
        ...
        "/api/v1/pay/reference": {
            post: {
                ...
                description: "Cria uma referência de pagamento através do gateway de pagamento.",
        ...
        "/api/v1/pay/webhook": {
            post: {
                ...
                description: "Endpoint para receber notificações do gateway de pagamento " +
        ...
        "/api/v1/env/save/{projectId}": {
            post: {
                ...
                description: "Guarda ou atualiza variáveis de ambiente de um projeto. " +
        ...
        "/api/v1/env/list/{projectId}": {
            get: {
                ...
                description: "Retorna a lista paginada de variáveis de ambiente de um projeto.",
        ...
        "/api/v1/project/metrics/{projectId}": {
            get: {
                ...
                description: "Retorna métricas específicas de um projeto (CPU, memória, etc).",
        ...
        "/api/v1/backoffice/project/list": {
            get: {
                ...
                description: "Endpoint administrativo para listar todos os projetos com " +
        ...
        "/api/v1/backoffice/pay/list": {
            get: {
                ...
                description: "Endpoint administrativo para listar todos os pagamentos.",
    ...
    components: {
        securitySchemes: {
            ...
            deployToken: {
                ...
                scheme: "bearer",
                bearerFormat: "UUID",
                description: "Token específico do projeto para fazer deploy.\n\n" +
